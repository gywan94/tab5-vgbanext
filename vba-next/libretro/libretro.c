...
/* tab5: this 136 KB save buffer would blow the ESP32-P4 internal DRAM budget at
 * link time; park it in PSRAM (.ext_ram.bss). Save data is not perf-critical. */
#ifdef ESP_PLATFORM
#include "esp_attr.h"
EXT_RAM_BSS_ATTR uint8_t libretro_save_buf[0x20000 + 0x2000];
#else
